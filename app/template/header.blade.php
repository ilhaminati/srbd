    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="#"><i class="fa fa-pencil-square-o"></i> <span>Tambah Data</span></a></li>
                <li><a href="#"><i class="fa fa-table"></i> <span>Lihat Data</span></a></li>
